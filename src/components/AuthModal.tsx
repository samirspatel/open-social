        ...
        <div className="p-6">
          <div className="space-y-4 mb-8">
            <div className="flex items-start space-x-3">
              <Users className="w-5 h-5 text-instagram-primary mt-0.5" />
              <div>
                <h3 className="font-semibold text-sm">Own Your Data</h3>
                <p className="text-instagram-text-light text-xs">Your posts, likes, and follows live in your GitHub repository</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <Lock className="w-5 h-5 text-instagram-secondary mt-0.5" />
              <div>
                <h3 className="font-semibold text-sm">Full Portability</h3>
                <p className="text-instagram-text-light text-xs">Switch apps anytime without losing your connections</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-instagram-text-light text-xs">Seamlessly connects with your existing GitHub account</p>
              </div>
            </div>
          </div>
